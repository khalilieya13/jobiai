        ...
        <div className="min-h-screen bg-indigo-50 py-12">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-8 bg-white p-6 rounded-lg shadow-sm border border-indigo-100">
                    <h2 className="text-xl font-semibold text-indigo-600 mb-2">Welcome to Company Profile Creation</h2>
                    <p className="text-gray-600">
                        Start building your company's presence by providing the essential information below.
                        A complete and accurate profile helps attract the right talent to your organization.
                    </p>
                </div>
