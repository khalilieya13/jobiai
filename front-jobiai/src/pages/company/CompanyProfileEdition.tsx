    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await axios.put(
                `http://localhost:5000/jobiai/api/company/${company._id}`, // Utiliser l'ID dans l'URL pour la mise à jour
                company,
                { headers }
            );
            ...
            navigate('/');  // Rediriger vers la page d'accueil ou la page souhaitée
        } catch (axiosError) {
            console.error('Erreur lors de la mise à jour de l\'entreprise:', axiosError);
